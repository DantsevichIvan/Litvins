...
// : any 1
// 1) доустановил в библиотеку react-hamburger-menu ts
// 2) !!! библиотека cheeseburger-menu не хочет типизироваться  ??? возможно надо использовать другую
// 3) вопрос по 2-м строчкам  isOpen={this.state.menuOpen}
