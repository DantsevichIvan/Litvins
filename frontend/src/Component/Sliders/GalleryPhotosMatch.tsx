...
// export default class GalleryPhotosMatch extends React.PureComponent<any> {

export const GalleryPhotosMatch = () => {
  ...
  return (
    <div className={styles.app} id="app">
      <div className={styles.btn}>
        {/*<button className={styles.btnPrev} onClick={() => slidePrev()}><span>Prev</span></button>*/}
        {/*<button className={styles.btnNext} onClick={() => slideNext()}><span>Next</span></button>*/}
        {/*<button className={styles.btnPrev} onClick={() => Carousel.slidePrev()}><span>Prev</span></button>*/}
        {/*<button className={styles.btnNext} onClick={() => Carousel.slideNext()}><span>Next</span></button>*/}
      </div>
      <AliceCarousel
